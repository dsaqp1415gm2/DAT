...
public interface MediaType {
  ...
  public final static String DAT_API_THEME = "application/vnd.dat.api.theme+json";
  public final static String DAT_API_ERROR = "application/vnd.dsa.beeter.error+json";
