...
public class ThemeResource {
	...
	private String GET_THREADS_QUERY = "select t.* from post p inner join thread t on t.idthread=p.idhilo where t.idtema=? group by t.idthread order by MAX(p.idpost) desc LIMIT 15";
