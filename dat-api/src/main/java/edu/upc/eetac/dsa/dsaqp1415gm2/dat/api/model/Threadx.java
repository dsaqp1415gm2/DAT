...
public class Threadx {
	@InjectLinks({
		...
		@InjectLink(value = "/thread/{idthread}", style = Style.ABSOLUTE, rel = "idthread", title = "threads link", type = MediaType.DAT_API_THREAD,bindings = {@Binding(name = "idthread", value = "${instance.idthread}")})})
